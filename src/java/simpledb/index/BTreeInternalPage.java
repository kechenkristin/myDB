...
public class BTreeInternalPage extends BTreePage {
    ...
    public Iterator<BTreeEntry> iterator() {
        return new BTreeInternalPageForwardIterator(this);
    }
...
/**
 * Abstract helper class that implements the Java Iterator for entries on a BTreeInternalPage.
 */
abstract class BTreeInternalPageIterator implements Iterator<BTreeEntry> {
    int curEntry = 1;
...
/**
 * Helper class that implements the Java Forward Iterator for entries on a BTreeInternalPage.
 */
class BTreeInternalPageForwardIterator extends BTreeInternalPageIterator {

    public BTreeInternalPageForwardIterator(BTreeInternalPage p) {
        super(p);
    }
 ...
 */
class BTreeInternalPageReverseIterator extends BTreeInternalPageIterator {
